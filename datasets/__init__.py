...
from datasets.seq_flower import SequentialFlower102
...
NAMES = {
    ...
    SequentialFlower102.NAME: SequentialFlower102,
}
...
def get_dataset_ood(args: Namespace) -> ContinualDataset:
    """
    Creates and returns a continual dataset.
    :param args: the arguments which contains the hyperparameters
    :return: the continual dataset
    """
    assert args.dataset_kwargs_ood['dataset'] in NAMES.keys()
    return NAMES[args.dataset_kwargs_ood['dataset']](args)
