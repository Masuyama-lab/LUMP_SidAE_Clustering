...
class LightDecoder(nn.Module):
    ...
    def __init__(
        ...
        self.inplanes = 64 # It should be the shape of the output image CHANEL from the previous layer (layer1).
        self.dilation = 1
        self.groups = groups
        ...
        self.layer1 = self._make_layer(block, 64, layers[0], stride=1 ,output_padding = 0, last_block_dim=64) # NOTE: last_block_dim must be equal with the initila self.inplanes
